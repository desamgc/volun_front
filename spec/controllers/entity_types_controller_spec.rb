...
RSpec.describe EntityTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested entity_type as @entity_type" do
      entity_type = EntityType.create! valid_attributes
      get :show, params: {id: entity_type.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested entity_type as @entity_type" do
      entity_type = EntityType.create! valid_attributes
      get :edit, params: {id: entity_type.to_param}, session: valid_session
      expect(assigns(:entity_type)).to eq(entity_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new EntityType" do
        expect {
          post :create, params: {entity_type: valid_attributes}, session: valid_session
      ...
      it "redirects to the created entity_type" do
        post :create, params: {entity_type: valid_attributes}, session: valid_session
        expect(response).to redirect_to(EntityType.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved entity_type as @entity_type" do
        post :create, params: {entity_type: invalid_attributes}, session: valid_session
        expect(assigns(:entity_type)).to be_a_new(EntityType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested entity_type" do
        entity_type = EntityType.create! valid_attributes
        put :update, params: {id: entity_type.to_param, entity_type: new_attributes}, session: valid_session
        entity_type.reload
      ...
      it "assigns the requested entity_type as @entity_type" do
        entity_type = EntityType.create! valid_attributes
        put :update, params: {id: entity_type.to_param, entity_type: valid_attributes}, session: valid_session
        expect(assigns(:entity_type)).to eq(entity_type)
      end
      ...
      it "redirects to the entity_type" do
        entity_type = EntityType.create! valid_attributes
        put :update, params: {id: entity_type.to_param, entity_type: valid_attributes}, session: valid_session
        expect(response).to redirect_to(entity_type)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the entity_type as @entity_type" do
        entity_type = EntityType.create! valid_attributes
        put :update, params: {id: entity_type.to_param, entity_type: invalid_attributes}, session: valid_session
        expect(assigns(:entity_type)).to eq(entity_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested entity_type" do
      entity_type = EntityType.create! valid_attributes
      expect {
        delete :destroy, params: {id: entity_type.to_param}, session: valid_session
      }.to change(EntityType, :count).by(-1)
    end
