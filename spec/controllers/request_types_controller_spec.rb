...
RSpec.describe RequestTypesController, type: :controller do
  ...
  # RequestType. As you add validations to RequestType, be sure to
  ...
  # RequestTypesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested request_type as @request_type" do
      request_type = RequestType.create! valid_attributes
      get :show, params: {id: request_type.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested request_type as @request_type" do
      request_type = RequestType.create! valid_attributes
      get :edit, params: {id: request_type.to_param}, session: valid_session
      expect(assigns(:request_type)).to eq(request_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new RequestType" do
        expect {
          post :create, params: {request_type: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved request_type as @request_type" do
        post :create, params: {request_type: invalid_attributes}, session: valid_session
        expect(assigns(:request_type)).to be_a_new(RequestType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested request_type" do
        request_type = RequestType.create! valid_attributes
        put :update, params: {id: request_type.to_param, request_type: new_attributes}, session: valid_session
        request_type.reload
      ...
      it "assigns the requested request_type as @request_type" do
        request_type = RequestType.create! valid_attributes
        put :update, params: {id: request_type.to_param, request_type: valid_attributes}, session: valid_session
        expect(assigns(:request_type)).to eq(request_type)
      end
    ...
    context "with invalid params" do
      it "assigns the request_type as @request_type" do
        request_type = RequestType.create! valid_attributes
        put :update, params: {id: request_type.to_param, request_type: invalid_attributes}, session: valid_session
        expect(assigns(:request_type)).to eq(request_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested request_type" do
      request_type = RequestType.create! valid_attributes
      expect {
        delete :destroy, params: {id: request_type.to_param}, session: valid_session
      }.to change(RequestType, :count).by(-1)
    end
