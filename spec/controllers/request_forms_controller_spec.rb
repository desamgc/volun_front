...
RSpec.describe RequestFormsController, type: :controller do
  ...
  # RequestForm. As you add validations to RequestForm, be sure to
  ...
  # RequestFormsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested request_form as @request_form" do
      request_form = RequestForm.create! valid_attributes
      get :show, params: {id: request_form.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested request_form as @request_form" do
      request_form = RequestForm.create! valid_attributes
      get :edit, params: {id: request_form.to_param}, session: valid_session
      expect(assigns(:request_form)).to eq(request_form)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new RequestForm" do
        expect {
          post :create, params: {request_form: valid_attributes}, session: valid_session
      ...
      it "redirects to the created request_form" do
        post :create, params: {request_form: valid_attributes}, session: valid_session
        expect(response).to redirect_to(RequestForm.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved request_form as @request_form" do
        post :create, params: {request_form: invalid_attributes}, session: valid_session
        expect(assigns(:request_form)).to be_a_new(RequestForm)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested request_form" do
        request_form = RequestForm.create! valid_attributes
        put :update, params: {id: request_form.to_param, request_form: new_attributes}, session: valid_session
        request_form.reload
      ...
      it "assigns the requested request_form as @request_form" do
        request_form = RequestForm.create! valid_attributes
        put :update, params: {id: request_form.to_param, request_form: valid_attributes}, session: valid_session
        expect(assigns(:request_form)).to eq(request_form)
      end

      it "redirects to the request_form" do
        request_form = RequestForm.create! valid_attributes
        put :update, params: {id: request_form.to_param, request_form: valid_attributes}, session: valid_session
        expect(response).to redirect_to(request_form)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the request_form as @request_form" do
        request_form = RequestForm.create! valid_attributes
        put :update, params: {id: request_form.to_param, request_form: invalid_attributes}, session: valid_session
        expect(assigns(:request_form)).to eq(request_form)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested request_form" do
      request_form = RequestForm.create! valid_attributes
      expect {
        delete :destroy, params: {id: request_form.to_param}, session: valid_session
      }.to change(RequestForm, :count).by(-1)
    end
